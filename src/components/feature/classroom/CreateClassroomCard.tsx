...
export const CreateClassroomCard = ({ onClick, userRole }: CreateClassroomCardProps) => {
    const isEducator = userRole === "EDUCATOR";
    const title = isEducator ? "Criar nova turma" : "Entrar em uma turma";
    const subtitle = isEducator ? "Configure nome e código" : "Use o código de convite";
